    ...
    module ApartmentManager
      ...
      def self.show_dialog
        ...
        html_content = <<-HTML
            ...
            <script>
              ...
              function addPricingScene(price_per_sqm = '', units_per_month = '') {
                ...
                div.innerHTML = '<input class="price_per_sqm" type="text" value="' + price_per_sqm + '" placeholder="销售场景' + (index + 1) + ' (元/平米)">'
                  + '<input class="units_per_month" type="text" value="' + units_per_month + '" placeholder="15套/月" >'
          ...
          <body>
            ...
            <div class="form-section">
              ...
              <input type="number" id="external_cost_per_sqm" value="5500">
        ...
        dialog.add_action_callback("delete_apartment_type") do |action_context, apartment_type_name|
          model = Sketchup.active_model
          model.delete_attribute('Urban_Banal', apartment_type_name)
...
# Urban_Banal::Real_Estate_Optimizer::ApartmentManager.show_dialog
